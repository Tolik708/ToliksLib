#ifndef TOLIK_VECTOR_TPP
#define TOLIK_VECTOR_TPP
...
namespace Detail
{
  ...
  // Vector
  template<typename Type, std::size_t Size> inline constexpr Vector<Type, Size, VectorFlag::Vector> DirectionalConstants<Type, Size, 1>::right()    { return Vector<Type, Size, VectorFlag::Vector>(NonScalar(), 1); }
  template<typename Type, std::size_t Size> inline constexpr Vector<Type, Size, VectorFlag::Vector> DirectionalConstants<Type, Size, 1>::left()     { return Vector<Type, Size, VectorFlag::Vector>(NonScalar(), -1); }
